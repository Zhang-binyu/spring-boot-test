...
public class StudentInfoController {
	...
	public PageUtils list(@RequestParam Map<String, Object> params){
		...
		List<StudentInfoDO> studentInfoDOs = studentInfoService.list(query);
		int total = studentInfoService.count(query);
		PageUtils pageUtils = new PageUtils(studentInfoDOs, total, query.getCurrPage(), query.getPageSize());
		return pageUtils;
	}
